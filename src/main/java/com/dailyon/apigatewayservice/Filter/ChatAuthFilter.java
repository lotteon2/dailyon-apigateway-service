...
@Slf4j
@Component
public class ChatAuthFilter extends AbstractGatewayFilterFactory<ChatAuthFilter.Config> {
  private final JwtUtil jwtUtil;

  public ChatAuthFilter(JwtUtil jwtUtil) {
    super(ChatAuthFilter.Config.class);
    ...
    return ((exchange, chain) -> {
      ...
      try {
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
          ...
          Claims claims = jwtUtil.parse(token, true);
